...
import type { Lang } from "../../interfaces/homepage.interface";
...
export default function TramPin({
  ...
  const pin = STATION_PIN_MAP[lang]?.[stationId];
  if (!pin) return null;
  ...
  return (
    <div
      className={`absolute z-30 -translate-x-1/2 -translate-y-full pointer-events-none transition-opacity duration-700 ease-in-out ${
