...
export default function KomeCard({
  ...
  return (
    <div className="px-7 py-2 rounded-[35px] flex flex-col gap-y-1 justify-center items-center border-2 shadow-[0_4px_4px_0_rgba(0,0,0,0.125)] border-[#D9D9D9] text-[#543A14] text-[16px] font-medium w-full">
