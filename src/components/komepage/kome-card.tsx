...
export default function KomeCard({
  ...
  return (
    ...
    <div
      ...
      className="bg-white px-7 py-2 rounded-full flex flex-col gap-y-1 justify-center items-center shadow-[0_0px_12.3px_0_rgba(50,33,21,0.15)] text-[#543A14] text-[16px] font-medium w-full"
    >
      <p className="text-center">{ml(name, i18n.language)}</p>
      <div className="flex justify-center items-center gap-x-3">
        <div className="w-6 h-6">
