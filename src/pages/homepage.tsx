...
export default function Homepage() {
  ...
  return (
    <main className="relative bg-[#FBFCF0] w-full h-full overflow-hidden">
      {!loaded && (
          ...
          <div className="inline-block absolute top-1 left-2.5 z-50">
            ...
            <div className="relative inline-block mt-0.5">
              <select
                ...
                className="outline-none appearance-none border border-[#C6C6C6] bg-white/90 backdrop-blur-sm pl-3 pr-8 py-1 rounded-full text-[12px] text-[#543A14] font-medium shadow-sm"
              >
                {TRAM_OPTIONS.map((o) => (
